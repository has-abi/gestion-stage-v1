...
public class RapportRest {
	...
	public Page<Rapport> findAllWithPagination(@PathVariable int page, @PathVariable int size,
			@PathVariable String sort) {
		return rapportService.findAllWithPagination(page, size, sort);
	}

	@PutMapping("/")
	public ResponseEntity<ResponseMessage> updateRapport(@RequestParam("titre") String titre,
			@RequestParam("desc") String description, @RequestParam("ref") String ref,
	...
	@PostMapping("/")
	public ResponseEntity<ResponseMessage> save(@RequestParam("titre") String titre,
			@RequestParam("desc") String description, @RequestParam("ref") String StageRef,
			@RequestParam("file") MultipartFile file) {
