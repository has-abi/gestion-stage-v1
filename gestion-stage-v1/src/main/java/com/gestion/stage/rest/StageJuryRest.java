...
public class StageJuryRest {
	...
	public List<StageMembreJury> findByMembreJuryUserNomContainsOrMembreJuryUserPrenomContains(String nom,
			String prenom) {
		return stageMembreJuryService.findByMembreJuryUserNomContainsOrMembreJuryUserPrenomContains(nom, prenom);
	}
	...
	public StageMembreJury findByMembreJuryReferenceAndStageReference(@PathVariable String reference,
